<?php
$public = $this->request->param('pass');
    ...
    <div class="row">
      <div class="col-md-9 col-md-push-3">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque, corporis doloremque atque minus a quo maiores voluptas aspernatur tenetur consectetur quod aliquid laborum modi! Quae saepe totam cumque eveniet architecto?</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum, dignissimos, suscipit consequatur reiciendis soluta vero ipsum impedit at recusandae alias repudiandae quo minima quaerat veniam necessitatibus delectus mollitia autem illo!</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, amet, voluptatum, in nobis commodi adipisci officia velit eveniet dolorem mollitia soluta consequuntur assumenda cupiditate deleniti unde qui fuga hic laborum.</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt, assumenda, harum aliquam laborum dolorem vel reprehenderit ullam magnam tempora ipsum facilis iusto dolores id provident deserunt similique quo et quis.</p>
...
<hr>
<?php //echo $this->Html->image('http://i.imgur.com/E4NBs5y.png', ['class' => 'img-responsive center-block']); ?>